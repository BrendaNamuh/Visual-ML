...
options.forEach(option=>{
  ...
  switch(curr_algo){
    case "SVM":
      ...
      curr_model = new models.SVM("http://localhost:8000/classification.csv",'http://localhost:8000/SVM_DATA.csv',svg);
    ...
    case "Linear Regression":
      curr_model = new models.LinearRegression("http://localhost:8000/Salary_Data.csv",'http://localhost:8000/LR_DATA.csv',svg);
